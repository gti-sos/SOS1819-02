...
app.controller("grafComCtrl", ["$scope", "$http", "$routeParams", "$location", function($scope, $http, $routeParams, $location) {
    ...
    $http.get(API).then(function(response) {
        ...
        Highcharts.chart('container', {
            ...
            series: [{
                name: 'Year 1800',
                data: [107, 31, 635, 203, 2, 3, 5, 7]
            }, {
                name: 'Year 1900',
                data: [133, 156, 947, 408, 6, 3, 5, 7]
            }, {
                name: 'Year 2000',
                data: [814, 841, 3714, 727, 31, 3, 5, 7]
            }, {
                name: 'Year 2016',
                data: [1216, 1001, 100, 738, 40,  3, 5, 7]
            }, {
                name: 'Year 2012',
                data: [1216, 1001, 436, 738, 40,  3, 5, 7]
            }, {
                name: 'Year 2013',
                data: [1216, 1001, 55, 738, 40, 3, 5, 7, 55, 213, 2354]
            }]
        });
